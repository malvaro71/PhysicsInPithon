# An object moves in such a way that its velocity at a certain instant is
# 120 m/s and forms an angle of 30º with the horizontal. Find the horizontal
...
print(f'The horizontal component of the object velocity is {velocity_x:.2f}'
      ' m/s')
print(f'The vertical component of the object velocity is {velocity_y:.2f}'
      ' m/s')
print(f'The object velocity vector is ({velocity[0]:.2f}, {velocity[1]:.2f})'
      ' m/s')
